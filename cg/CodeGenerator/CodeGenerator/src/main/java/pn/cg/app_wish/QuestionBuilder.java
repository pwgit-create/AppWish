...
public class QuestionBuilder {
    ...
    /**
     * Creates a questions for OpenAi model that should produce java codes of a feature
     *
     * @return String
    ...
    /**
     * Creates a questions for OpenAi model that should produce java code of a class (in a feature)
     *
    ...
    /**
     * Creates a question for OpenAi model that should produce a correct implementation of class that did not compile
     *
    ...
    /**
     * Creates a question for OpenAi model that should produce a list of classes that is needed to create an app from the users wish
     *
     * @return String
