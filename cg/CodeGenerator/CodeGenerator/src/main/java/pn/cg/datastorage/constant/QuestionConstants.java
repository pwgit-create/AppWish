...
public class QuestionConstants {
    ...
    /**
     * A prefix for a question that asks the OpenAi model to code a whole feature/app
     *
     * @use-info The app wish should be concatenated at the tail of this String
     */
    public final static String APP_WISH_PREFIX_FEATURE = "Provide me java code on ";
    ...
    /**
     * Message that should be sent to the OpenAi model when a compilation of a class fails (with javac output)
     *
    ...
    /**
     * Message that should be sent to the OpenAi model when a compilation of a class fails (without javac output)
     *
     * @use-info as is
     */
    ...
    /**
     * Prefix that should be sent to fetch a list of classes from the OpenAi model
     *
     * @use-info The app wish should be concatenated at the tail of this String
